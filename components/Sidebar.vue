  ...
  >
    <template #container>
      <div class="flex flex-col h-full bg-white dark:bg-gray-900">
        ...
        <!-- Sidebar Content -->
        <div class="flex-grow overflow-y-auto py-2 px-3">
          <!-- Main Navigation Section -->
          <div class="mb-5">
            <div
              class="text-xs font-semibold uppercase text-gray-500 dark:text-gray-400 px-3 mb-2"
            >
              Navigation
            </div>
            <SidebarMenuItem
          ...
          <div class="mb-5">
            ...
            <SidebarMenuItem v-for="(item, idx) in adminItems" :key="idx" :item="item" />
          </div>
        </div>
